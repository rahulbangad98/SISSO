...
#                             property_key_column_lower = property_key_column.strip().lower()
#                             non_critical_columns = [col for col in df.columns if col != property_key_column_lower]
                    ...
                    if os.path.exists(sisso_file_path):
                        ...
                        if os.path.exists(additional_file_source_path):
                            ...
                            try:
                                ...
                                # Print the columns before any processing
                                print(f"Columns before processing for iteration {iteration_dir}: {df.columns.tolist()}")
                                ...
                                df.columns = df.columns.str.lower()  # Ensure all column names are in lowercase
                                df.to_csv(additional_file_destination_path, index=True)
                                print(f"Processed and saved {additional_file_destination_path}")
